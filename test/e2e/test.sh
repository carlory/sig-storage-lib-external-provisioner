...
pushd $GOPATH/src/github.com/carlory/sig-storage-lib-external-provisioner/test/e2e
...
pushd $GOPATH/src/github.com/carlory/sig-storage-lib-external-provisioner/examples/hostpath-provisioner
make image
