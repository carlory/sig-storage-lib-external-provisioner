...
// NewVolumeResizeMap returns VolumeResizeMap
func NewVolumeResizeMap(kubeClient kubernetes.Interface) VolumeResizeMap {
...
func (resizeMap *volumeResizeMap) GetPVCsWithResizeRequest() []*PVCWithResizeRequest {
	...
	// Empty our pvcrs map, we will add back failed resize request later
